                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="icon" id="icon-input" class="form-control" value="star" readonly>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="details_description_subtitle" class="form-control" placeholder="e.g. Professional Care">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Section Title</label>
                                        <input type="text" name="details_description_title" class="form-control" value="Keep Your Equipment Safe & Reliable">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Section Subtitle</label>
                                        <input type="text" name="tutorial_section_subtitle" class="form-control" placeholder="e.g. Learn More">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Section Title</label>
                                        <input type="text" name="tutorial_section_title" class="form-control" placeholder="e.g. Video Tutorials">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Section Subtitle</label>
                                        <input type="text" name="specifications[subtitle]" class="form-control" value="Our Services">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Section Title</label>
                                        <input type="text" name="specifications[title]" class="form-control" value="What We Offer">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div id="variants-container">
                                    <!-- Dynamic Service Offerings will be added here -->
                                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Section Title</label>
                                        <input type="text" name="features[title]" class="form-control" value="Service Features">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="others_data[cta_title]" class="form-control" value="Need this Service?">
                                <small class="form-text text-muted">The main heading for the call-to-action section at the bottom.</small>
                            </div>
                            <div class="form-group">
                                <label>CTA Subtitle</label>
                                <textarea name="others_data[cta_subtitle]" class="form-control" rows="2">Contact us for scheduling or more information.</textarea>
                                ...
                                <table class="table table-bordered mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" name="sections[details_description][order]" class="form-control" value="1" min="0" step="1">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" name="sections[specifications][order]" class="form-control" value="2" min="0" step="1">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Tutorial</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" name="sections[features][order]" class="form-control" value="4" min="0" step="1">
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
