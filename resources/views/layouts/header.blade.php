...
<div class="bg-secondary text-secondary-foreground py-2 text-sm hidden md:block">
    <div class="container mx-auto px-4 flex justify-between items-center">
        <div class="flex items-center gap-6">
            <a href="mailto:sdgases.mgmt@gmail.com" class="flex items-center gap-2 hover:text-primary transition-colors">
                ...
                sdgases.mgmt@gmail.com
            </a>
            <a href="tel:+01-5533950" class="flex items-center gap-2 hover:text-primary transition-colors">
        ...
        <p class="text-muted-foreground">Patan Dhoka, Lalitpur, Nepal</p>
    </div>
</div>
    ...
    <div class="container mx-auto px-4">
        <div class="flex items-center justify-between h-20">
            <a href="{{ route('home') }}" class="flex items-center">
                <img src="{{ asset('images/sdgases-logo.png') }}" alt="SD Gases" class="h-12 md:h-14 w-auto" />
            </a>
            ...
            <nav class="hidden lg:flex items-center gap-1">
                ...
                <div class="relative group">
                    ...
                    <div class="absolute top-full left-0 pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                        <div class="bg-card rounded-xl shadow-xl border border-border p-2 min-w-48">
                            <a href="{{ route('products.himalayan-oxygen') }}" class="block px-4 py-2 text-sm text-foreground/80 hover:bg-accent hover:text-primary rounded-lg transition-colors">Himalayan Oxygen</a>
                            <a href="{{ route('products.medical-oxygen') }}" class="block px-4 py-2 text-sm text-foreground/80 hover:bg-accent hover:text-primary rounded-lg transition-colors">Medical Oxygen</a>
                            <a href="{{ route('products.industrial-gas') }}" class="block px-4 py-2 text-sm text-foreground/80 hover:bg-accent hover:text-primary rounded-lg transition-colors">Industrial Gas</a>
                            <a href="{{ route('products.emergency-oxygen') }}" class="block px-4 py-2 text-sm text-foreground/80 hover:bg-accent hover:text-primary rounded-lg transition-colors">Emergency Oxygen</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative group">
                    ...
                    <div class="absolute top-full left-0 pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                        <div class="bg-card rounded-xl shadow-xl border border-border p-2 min-w-48">
                            <a href="{{ route('services.cylinder-refilling') }}" class="block px-4 py-2 text-sm text-foreground/80 hover:bg-accent hover:text-primary rounded-lg transition-colors">Cylinder Refilling</a>
                            <a href="{{ route('services.equipment-rental') }}" class="block px-4 py-2 text-sm text-foreground/80 hover:bg-accent hover:text-primary rounded-lg transition-colors">Equipment Rental</a>
                            <a href="{{ route('services.maintenance') }}" class="block px-4 py-2 text-sm text-foreground/80 hover:bg-accent hover:text-primary rounded-lg transition-colors">Maintenance & Repair</a>
                            <a href="{{ route('services.bulk-supply') }}" class="block px-4 py-2 text-sm text-foreground/80 hover:bg-accent hover:text-primary rounded-lg transition-colors">Bulk Supply</a>
                        </div>
                    </div>
                </div>

                {{-- Contact --}}
                <a href="{{ route('contact') }}" class="px-4 py-2 text-foreground/80 font-medium hover:text-primary transition-colors flex items-center gap-1">Contact</a>
    ...
    >
        ...
        <div x-data="{ open: false }">
            ...
            <div x-show="open" class="pl-4 py-2 flex flex-col gap-2 bg-accent/30 rounded-lg mt-2">
                <a href="{{ route('products.himalayan-oxygen') }}" class="py-2 text-foreground/80">Himalayan Oxygen</a>
                <a href="{{ route('products.medical-oxygen') }}" class="py-2 text-foreground/80">Medical Oxygen</a>
                <a href="{{ route('products.industrial-gas') }}" class="py-2 text-foreground/80">Industrial Gas</a>
                <a href="{{ route('products.emergency-oxygen') }}" class="py-2 text-foreground/80">Emergency Oxygen</a>
            </div>
        </div>
        ...
        <div x-data="{ open: false }">
            ...
            <div x-show="open" class="pl-4 py-2 flex flex-col gap-2 bg-accent/30 rounded-lg mt-2">
                <a href="{{ route('services.cylinder-refilling') }}" class="py-2 text-foreground/80">Cylinder Refilling</a>
                <a href="{{ route('services.equipment-rental') }}" class="py-2 text-foreground/80">Equipment Rental</a>
                <a href="{{ route('services.maintenance') }}" class="py-2 text-foreground/80">Maintenance & Repair</a>
                <a href="{{ route('services.bulk-supply') }}" class="py-2 text-foreground/80">Bulk Supply</a>
            </div>
        </div>
